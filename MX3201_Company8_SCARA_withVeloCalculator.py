...
# Window and Title
MX3201_Company8_SCARA = Tk()
MX3201_Company8_SCARA.title("SCARA Calculator")
MX3201_Company8_SCARA.resizable(False, False)
MX3201_Company8_SCARA.configure(bg="sky blue")
...
# Button Frame
BF = LabelFrame(MX3201_Company8_SCARA,text="Forward Kinematics",font=(5),bg="sky blue",fg="black")
BF.grid(row=1,column=0)

# Buttons
FK = Button(BF,text="Forward",font=(10),bg="hot pink",fg="black",command=f_k)
rst = Button(BF,text="RESET",font=(10),bg="orchid",fg="black",command=reset)
IK = Button(BF,text="↑ Inverse",font=(10),bg="hot pink",fg="black",command=i_k)
...
PV = LabelFrame(MX3201_Company8_SCARA,text="Position Vectors",font=(5),bg="sky blue",fg="black")
PV.grid(row=2,column=0)

# Position Vectors Label
X = Label(PV,text="X = ",font=(10),bg="hot pink",fg="black")
X_E = Entry(PV,width=5,font=10,bg="white",fg="black")
cm7 = Label(PV,text="cm",font=(10),bg="orchid",fg="black")

Y = Label(PV,text="Y = ",font=(10),bg="hot pink",fg="black")
Y_E = Entry(PV,width=5,font=10,bg="white",fg="black")
cm8 = Label(PV,text="cm",font=(10),bg="orchid",fg="black")

Z = Label(PV,text="Z = ",font=(10),bg="hot pink",fg="black")
...
PI = Label(MX3201_Company8_SCARA,image=img)
PI.grid(row=3,column=0)

MX3201_Company8_SCARA.mainloop()